; BEGIN BUILTINS.ISS
//
// Inno Setup Preprocessor 1.1
//
// Copyright (C) 2001-2002 Alex Yackimoff. All Rights Reserved.
// http://ispp.sourceforge.net
//
// Inno Setup (C) 1998-2002 Jordan Russell. All Rights Reserved. Portions by Martijn Laan.
// My Inno Setup Extensions (C) 2000-2002 Martijn Laan. All Rights Reserved.
//
// $Id: Builtins.iss,v 1.2 2004/05/29 15:37:47 mlaan Exp $
//
