/******************************************************************************
 ...
 Programma      : V:\SAMPLES\TUTORIAL\source\About.prg
...
oWin := 0->(TbBrwNew(  660                        ,; // Prima  Riga
                       120                        ,; // Prima  Colonna
                       252                        ,; // Ultima Riga
                       400                        ,; // Ultima Colonna
...
/*ÚÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ¿
  ³ Control                     ³
  ÀÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÙ*/
ATTACH "say0007" TO oWin:W_CONTROL SAY "Per conoscere i passi per costruire questo progetto consulta il Tutorial" AT   20,  30  ; // ATTSAY.TMP
                 SIZE       { 200,  30}            ; // Dimensioni Campo get
                 COORDINATE  W_COORDINATE_PIXEL    ; // Coordinate in Pixel
                 ALIGNMENT XBPALIGN_WORDBREAK      ; // SAY ALIGNMENT
                 FONT      "8.Verdana"             ; // Font Name (XBASE)
                 COLOR    {DFXPPCLRSELECT("/[0]","N/G")}    // Array dei colori
ATTACH "say0005" TO oWin:W_CONTROL SAY "Tutorial Visual dBsee" AT   70,  30  ; // ATTSAY.TMP
                 SIZE       { 222,  20}            ; // Dimensioni Campo get
                 COORDINATE  W_COORDINATE_PIXEL    ; // Coordinate in Pixel
                 ALIGNMENT XBPALIGN_DEFAULT        ; // SAY ALIGNMENT
                 FONT      "10.Verdana Bold"       ; // Font Name (XBASE)
                 COLOR    {DFXPPCLRSELECT("/[0]","N/G")}    // Array dei colori
ATTACH "say0004" TO oWin:W_CONTROL SAY "Albalog s.r.l." AT   90, 300  ; // ATTSAY.TMP
                 SIZE       { 100,  31}            ; // Dimensioni Campo get
                 COORDINATE  W_COORDINATE_PIXEL    ; // Coordinate in Pixel
                 ALIGNMENT XBPALIGN_DEFAULT        ; // SAY ALIGNMENT
                 FONT      "10.Verdana Bold"       ; // Font Name (XBASE)
                 COLOR    {DFXPPCLRSELECT("/","N/G")}    // Array dei colori
ATTACH "say0003" TO oWin:W_CONTROL SAY "Applicazione sviluppata con Visual dBsee" AT  130,   0  ; // ATTSAY.TMP
                 SIZE       { 410,  42}            ; // Dimensioni Campo get
                 COORDINATE  W_COORDINATE_PIXEL    ; // Coordinate in Pixel
