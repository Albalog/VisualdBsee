/******************************************************************************
 ...
 Programma      : V:\SAMPLES\TUTORIAL\source\CliRpt.prg
 Template       : V:\bin\..\tmp\xbase\report.tmp
 Descrizione    : Scheda Clienti (Report Manager)
 Programmatore  : Demo
 Data           : 13-07-06
 Ora            : 16.43.59
******************************************************************************/
...
*******************************************************************************
FUNCTION CliRptExe( ;                              // [ 01 ]  ESECUTORE OPERAZIONI
...
PRIVATE  EnvId:="CliRpt" ,SubId:=""                // Variabili di ambiente per report

aBuffer := dfPrnCfg()                              //  Inizializzazione array statico ( vedere Norton Guide )

IF CliRptDbf()                                     // Apertura File
   IF EMPTY( aVRec )
...
*******************************************************************************
FUNCTION CliRptDbf()                               // [ 02 ] APERTURA DATABASE
*******************************************************************************
...
aBuffer[ REP_NAME ]          := "Scheda Clienti (Report Manager)"  //  Intestazione report
aBuffer[ REP_VREC ]          := aVRec

// ReportManager
dfRepManReportSet(aBuffer, dfReportManagerPath()+"CliRpt.REP")
...
*******************************************************************************
STATIC PROCEDURE CliRptQry()                       // Modulo di query
*******************************************************************************
...
dfReportOutPut(    0,    4, Clienti->PrvCli, {"PrvCli","C",2,0},"CLIENTI","Clienti->PrvCli"  )
Province->(dfS(1, Upper(Clienti->PrvCli)))
dfReportOutPut(    0,    5, Province->DesPrv, {"DesPrv","C",20,0},"CLIENTI","Province->DesPrv"  )
dfReportOutPut(    0,    6, dfTime(), {"exp0006", "C",10,0 },"CLIENTI" )
dfReportOutPut(    0,    7, Clienti->CitCli, {"CitCli","C",13,0},"CLIENTI","Clienti->CitCli"  )
dfReportOutPut(    0,    8, Clienti->RagCli, {"RagCli","C",30,0},"CLIENTI","Clienti->RagCli"  )
